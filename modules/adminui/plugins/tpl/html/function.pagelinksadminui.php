 ...
 *  */
function jtpl_function_html_pagelinksadminui(
    $tpl,
    $action,
    $actionParams,
    $itemsTotal,
    ...
    $defaultDisplayProperties = array(
        ...
        'end-class' => 'page-item',
        'area-size' => 0,
        'list-class' => 'pagination justify-content-center m-0',
        'current-page-class' => 'page-item active',
    ...
    if ($itemsTotal > $pageSize) {
        ...
        for ($curidx = 0; $curidx < $itemsTotal; $curidx += $pageSize) {
            if ($offset >= $curidx && $offset < $curidx + $pageSize) {
                $pages[$numpage] = '<li class="'.$displayProperties['current-page-class'].'"><a href="#" class="page-link">'.$numpage.'</a></li>';
                ...
                $pages[$numpage] = '<li class="'.$displayProperties['page-class'].'"><a href="'.$url->toString(true).'" class="page-link">'.$numpage.'</a></li>';
            }
            ++$numpage;
        }
        ...
        if (!empty($displayProperties['start-label'])) {
            ...
            if ($prevBound >= 0) {
                echo '"><a href="', $urlStartPage->toString(true), '" class="page-link">', $displayProperties['start-label'], '</a>';
            } else {
                echo ' '.$displayProperties['disabled-class'].'"><a href="#" class="page-link">',$displayProperties['start-label'], '</a>';
            }
            echo '</li>', "\n";
        }
        ...
        if (!empty($displayProperties['prev-label'])) {
            ...
            if ($prevBound >= 0) {
                echo '"><a href="', $urlPrevPage->toString(true), '" class="page-link">', $displayProperties['prev-label'], '</a>';
            } else {
                echo ' '.$displayProperties['disabled-class'].'"><a href="#" class="page-link">',$displayProperties['prev-label'], '</a>';
            }
            echo '</li>', "\n";
        }
        ...
        if (!empty($displayProperties['next-label'])) {
            ...
            if ($nextBound < $itemsTotal) {
                echo '"><a href="', $urlNextPage->toString(true), '" class="page-link">', $displayProperties['next-label'], '</a>';
            } else {
                echo ' '.$displayProperties['disabled-class'].'"><a href="#" class="page-link">',$displayProperties['next-label'], '</a>';
            }
            echo '</li>', "\n";
        }
        ...
        if (!empty($displayProperties['end-label'])) {
            ...
            if ($nextBound < $itemsTotal) {
                echo '"><a href="', $urlEndPage->toString(true), '" class="page-link">', $displayProperties['end-label'], '</a>';
            } else {
                echo ' '.$displayProperties['disabled-class'].'"><a href="#" class="page-link">',$displayProperties['end-label'], '</a>';
            }
            echo '</li>', "\n";
        }
        ...
        echo '<ul class="'.$displayProperties['list-class'].'"><li class="'.$displayProperties['current-page-class'].'"><a href="#" class="page-link">1</a></li></ul>';
    }
}
